...
public class MQFontChooser extends JDialog {
	 ...
	 * “字体”，“字形”，“大小”三个列的宽度
	 */
	private static final int fontStyleColWidth = 230;
//	private static final int fontShapeColWidth = 95;
//	private static final int fontSizeColWidth = 80;
	/**
	 * 选择取消按钮的返回值
	 */
	...
	private void init(){
		...
		l1.setPreferredSize(new Dimension(fontStyleColWidth, 14));
		l1.setMaximumSize(new Dimension(fontStyleColWidth, 14));
		l1.setMinimumSize(new Dimension(fontStyleColWidth, 14));
		...
		fontText.setPreferredSize(new Dimension(fontStyleColWidth, 20));
		fontText.setMaximumSize(new Dimension(fontStyleColWidth, 20));
		fontText.setMinimumSize(new Dimension(fontStyleColWidth, 20));
		box2.add(fontText);
		...
		sp1.setPreferredSize(new Dimension(fontStyleColWidth, 100));
		sp1.setMaximumSize(new Dimension(fontStyleColWidth, 100));
		sp1.setMaximumSize(new Dimension(fontStyleColWidth, 100));
		box3.add(sp1);
		...
		box5.setPreferredSize(new Dimension(100, 95));
		box5.setMaximumSize(new Dimension(100, 95));
		box5.setMinimumSize(new Dimension(100, 95));
